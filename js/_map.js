...
(function () {
  _0x20e2fe(this, function () {
    ...
    console.log(new RegExp(_0x6f138e(0x14e)), _0x5e537c(_0x6f138e(0xf7)))
...
_0x5edf1f();
let viewer, toolbar, layerList, setupMouseTracking, lastClickPosition, setLayout, format, showInfo, hideInfo, getTableRow, getMappedData, resizing, marker, lastMousePosition, layerNames, infoShowing = ![],
  $ = giscloud["exposeJQuery"](),
  apiKey = _0x3bf18f(0xc9),
  mapId = _0x3bf18f(0xa4),
  fid = '', lid = '',
  field = '', value = '',
  ...
  isLive = ![],
  liveInterval = null,
  selectedFeatureX = 0x0,
  selectedFeatureY = 0x0,
  elGraveInfoSidepanel = _0x3bf18f(0xef),
  elMenuSidepanel = _0x3bf18f(0x145),
  $btnShowOnMap = $(_0x3bf18f(0x10b)),
  $elGraveInfoImage = $(_0x3bf18f(0x13c)),
  $elGraveInfoTag = $('#oznaka'),
  $elGraveInfoOwner = $(_0x3bf18f(0xeb)),
  $elGraveInfoUser = $('#korisnik'),
  $elSearchResultList = $('#search-results-list'),
  $btnSearch = $(_0x3bf18f(0x171)), $elSearchBar =
    $(_0x3bf18f(0x15c)),
  $elMenuItem = $('.main-menu-items\x20button'),
  $btnLocateMe = $(_0x3bf18f(0xd7)),
  elOverlaySearch = _0x3bf18f(0xd9),
  elOverlayApp = _0x3bf18f(0x109),
  $elOverlaySpinner = $('.spinner-overlay'),
  $elOverlaySearch = $(elOverlaySearch),
  $elOverlayApp = $(elOverlayApp),
  $btnCloseSearch = $('#close-search'),
  $btnReport = $(_0x3bf18f(0x123)),
  $btnImpressum = $(_0x3bf18f(0xd8)),
  $btnTutorial = $(_0x3bf18f(0x16c)),
  $btnMenu = $(_0x3bf18f(0xa6)),
  $btnFaq = $(_0x3bf18f(0x149)),
  $btnBack = $(_0x3bf18f(0xc3)),
  $contactForm = $(_0x3bf18f(0x124)),
  $contactFormContainer = $(_0x3bf18f(0xc4)),
  formHtml = $contactFormContainer[_0x3bf18f(0xa7)](),
  $formWarning = $(_0x3bf18f(0x13f)),
  $btnContactFormSubmit = $(_0x3bf18f(0x161)),
  $imgOverlay = $(_0x3bf18f(0x11d)),
  startingGraveyardName = _0x3bf18f(0xfd),
  selectedGraveyardId = startingGraveyardName,
  selectedGraveyardName = startingGraveyardName,
  selectedFeatureId = null, previousSearchTerm = null,
  $btnNewReport = $(_0x3bf18f(0xc7)),
  reportModal = _0x3bf18f(0xa2),
  impressumModal = _0x3bf18f(0x16f),
  tutorialModal = _0x3bf18f(0x162),
  faqModal = '#faq-modal',
  pointGrave = null,
  graveLonLat = null,
  pointUser = null,
  userLonLat = null,
  locatorMultiplier = 0.2,
  activeState = null,
  activeStates = {
...
$elSearchResultList['on']('click', 'li', function () {
  ...
  $btnShowOnMap['on']('click', function () {
  ...
  ,
  window[_0x3bf18f(0xb0)]('popstate', function () {
    var _0x3d4ab3 = _0x3bf18f;
    console.log(_0x39b5ff)
    if (activeState === null)
      history['back']();
    else {
...
function createMarker(color, position) {
  ...
  var _0x30a5a6 = new giscloud['GraphicStyle'](style);
  var _0x2f80f8 = new giscloud.geometry.Point(position[_0xb5e8ca(0x175)], position[_0xb5e8ca(0x16d)]);
  return new giscloud['GraphicFeature'](_0x2f80f8, _0x30a5a6);
}

function drawGraveMarker(_0x34f8d0) {
  var _0x3bec49 = _0x3bf18f;
  viewer.graphic.remove(pointGrave);
  ...
  viewer.graphic.add(pointGrave);
}

function drawUserMarker(_0x5c02d0) {
  var text = "o";
  var markerIcon = { url: './img/marker.png', width: 40, height: 40 };
  if (_marker) {
    viewer.removeMarker(_marker);
    _marker.location(_0x5c02d0);
    _marker.icon(markerIcon);
    // viewer.addMarker(_marker); //add marker to map
  }
  if (!_marker) {
    _marker = new giscloud.Marker(); //create marker
    _marker.location(_0x5c02d0);
    _marker.icon(markerIcon);
    // viewer.addMarker(_marker); //add marker to map
  }
...
function success(_0x50e094) {
  console.log(pointUser);
  var _0x168854 = _0x168854 || window._0x168854;
  if (!_0x168854)
    return
  var _0x1d4c26 = _0x168854, _0x25dc05 = new Proj4js[(_0x1d4c26(0x16a))](_0x50e094[_0x1d4c26(0x159)]['longitude'], _0x50e094['coords'][_0x1d4c26(0x127)]), _0x5c81e7 = Math[_0x1d4c26(0xe6)](_0x50e094[_0x1d4c26(0x159)][_0x1d4c26(0x13e)], 0x46), _0xd025b9 = viewer[_0x1d4c26(0x128)](), _0x2b032f, _0x216723, _0xd9442f, _0x1ae391 = window[_0x1d4c26(0x142)][_0x1d4c26(0xfb)], _0x199b91 = _0x1ae391[_0x1d4c26(0xc2)](_0x1d4c26(0xc5));
  // var t = new Proj4js[(_0x1d4c26(0x16a))](_0x50e094[_0x1d4c26(0x159)]['longitude'], _0x50e094['coords'][_0x1d4c26(0x127)]);
  const x = _0x25dc05['x'];
  const y = _0x25dc05['y'];
  // drawUserMarker(new giscloud['LonLat'](x, y));
  // drawUserMarker(new giscloud['LonLat'](_0x25dc05['x'], _0x25dc05['y']));
  // locate();

  function successTemp(_0x50e094) {
    var _0x1d4c26 = _0x168854, _0x25dc05 = new Proj4js[(_0x1d4c26(0x16a))](_0x50e094[_0x1d4c26(0x159)]['longitude'], _0x50e094['coords'][_0x1d4c26(0x127)]), _0x5c81e7 = Math[_0x1d4c26(0xe6)](_0x50e094[_0x1d4c26(0x159)][_0x1d4c26(0x13e)], 0x46), _0xd025b9 = viewer[_0x1d4c26(0x128)](), _0x2b032f, _0x216723, _0xd9442f, _0x1ae391 = window[_0x1d4c26(0x142)][_0x1d4c26(0xfb)], _0x199b91 = _0x1ae391[_0x1d4c26(0xc2)](_0x1d4c26(0xc5));
    window._0x168854 = _0x168854;
    typeof viewer[_0x1d4c26(0x112)] === _0x1d4c26(0xac) && (Proj4js[_0x1d4c26(0x133)][_0x1d4c26(0xe1)] = viewer[_0x1d4c26(0x112)],
      viewer[_0x1d4c26(0x112)] = new Proj4js[(_0x1d4c26(0x172))](_0x1d4c26(0xe1)));
  ...
  successTemp(_0x50e094)
}

function addGreenButton() {
  $btnLocateMe.addClass('locate-me-green')
  $btnLocateMe.hide();
  $btnLocateMe.show();
...
function animate() {
  position2.x += 0.001;
  drawUserMarker(new giscloud['LonLat'](position2.x, position2.y));
}
